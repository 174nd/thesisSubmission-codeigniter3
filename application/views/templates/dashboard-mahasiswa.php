...
<body class="hold-transition layout-top-nav text-sm">
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand-md navbar-light">
      <div class="container">
        ...
        <a href="<?= base_url('mahasiswa'); ?>" class="navbar-brand">
  ...
  <div class="modal fade" id="update-password">
    <form method="POST" action="<?= base_url('mahasiswa'); ?>" class="modal-dialog">
  ...
  <div class="modal fade" id="update-photo">
    <form method="POST" action="<?= base_url('mahasiswa'); ?>" class="modal-dialog" enctype="multipart/form-data" autocomplete="off">
      <div class="modal-content">
        <div class="modal-header">
